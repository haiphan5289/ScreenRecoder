...
public class Settings: SettingsKeys {
    ...
    static public var sharedInstance = Settings() // Singleton pattern in Swift
    ...
    public let hardware = "DeviceGuruImplementation().hardware"
    
    public var isHEVCSupported = false
    ...
    public let default_snapshot_format = "jpg"
    public let default_volume_keys = "off"
    public let volume_keys_enabled = "on"

    public let CONFIG_BACK_LENS: [String: String]
    
    public let viewModeMap: [String: AVLayerVideoGravity] = ["fill" : .resizeAspectFill, "fit": .resizeAspect]
    public let viewModeDefault = "fill"
    ...
    public let VideoBitrates: [String:Int] = ["2160":4500, "1080":3000, "720":2000, "540":1500, "480":1000, "360":700, "288":500, "144":300]
    ...
    public func videoSize(cameraID: String) -> CMVideoDimensions {
    ...
    public var videoCodecType: CMVideoCodecType {
    ...
    var canPostprocess: Bool {
        ...
        let hw = "DeviceGuruImplementation().hardwareString"
    ...
    @available (iOS 11.0, *)
    public func isHEVCEncodingSupported(size: CMVideoDimensions) -> Bool {
