...
//  BasicExtension
//
//  Created by haiphan on 22/05/2023.
//
...
//    let userDefault = UserDefaults(suiteName: "group.com.hpscreenrecorder1")
...
//        }
    ...
    private func scheduleNotification() {
        ...
        let notificationRequest: UNNotificationRequest = .init(
            identifier: "group.com.metaic.screenrecorder1.notification",
            content: content,
            trigger: trigger
        )
