...
{
    func defaultConfiguration(font: UIFont = UIFont.workSansRegular(size: 17), color: UIColor = UIColor.black) {
    ...
    func selectedConfiguration(font: UIFont = UIFont.workSansBold(size: 17), color: UIColor = UIColor.white) {
...
extension Modal where Self: UIView {
    func show(animated: Bool) {
        ...
        if var topController = UIApplication.shared.keyWindowInConnectedScenes?.rootViewController {
            ...
            UIApplication.shared.keyWindowInConnectedScenes?.rootViewController?.view.addSubview(self)
        }
        if animated {
